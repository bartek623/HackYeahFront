...
function Profile(){
    ...
    const changeHandler = function(){
        if(inputUName.current.value!=='' || inputAddr.current.value!=='' || inputLName.current.value!=='' || inputFName.current.value!==''){
            setDisabled(false);
            return;
        }
    ...
    return <div className={style.container}>
                    <fieldset className={style.fildek}>
                        <div className={style.divek}><label>User name: </label></div>
                        <div className={style.divek}><label>Number of tokens: </label></div>
                        <div className={style.divek}><label>First name: </label></div>
                        <div className={style.divek}><label>Last name: </label></div>
